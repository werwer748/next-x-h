...
export default function ActionButtons({ white }: TProps) {
  ...
  /**
   * classnames의 사용법은 다양하지만 결론은 조건부로 클래스명을 컨트롤하는 것
   * cx 인자가 true조건이면 렌더링이 된다는게 핵심
   *
   * cx(style.commentButton, {[style.commented]: commented})
   * cx(style.repostButton, reposted && style.reposted)
   * cx([style.heartButton, liked && style.liked])
   */
  return (
